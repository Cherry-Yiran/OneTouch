...
const COPY = {
  en: {
    ...
    feishuAily: ['Feishu aily', 'Starts the aily background service'],
  },
  zh: {
    ...
    feishuAily: ['飞书 aily', '启动飞书 aily 后台服务'],
  },
};
...
const INITIAL_SWITCHES = { desktop: true, darkMode: true, awake: false, airpods: true, dnd: true, nightShift: true, screenSaver: false, trueTone: true, frontApp: false, muteMic: false, xcodeClean: false, emptyTrash: false, clearDownloads: false, ejectDisk: false, clipboard: false, hideWindow: false, hideDock: false, lowPower: false, highPower: false, music: false, spotify: false, hiddenFiles: false, displaySleep: false, resolution: false, hideWidgets: false, stageManager: false, cleanScreen: false, lockKeyboard: false, lockScreen: false, quitApps: false, feishuAily: false };
...
function localiseNativeError(error, language, text) {
  ...
  if (/aily-cli is not installed/i.test(message)) return '这台 Mac 尚未安装 aily-cli';
  if (/aily-cli did not respond/i.test(message)) return 'aily-cli 响应超时，请稍后重试';
